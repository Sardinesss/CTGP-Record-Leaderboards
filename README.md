...
<img alt="All Leaderboards" src="website/images/indexCTGP.png" height=600>
...
<img alt="Leaderboard API Data" src="website/images/leaderboardCTGP.png" height=600>
...
<img alt="Ghost API Data" src="website/images/ghostCTGP.png" height=600>

Here the important information like characterId, vehicleId, playerId, etc. can be found. PlayerId is used to match a real person to this record. The other Ids are only numbers and need to be converted to what they represent. In the code, a switch case statement is used but I have also created a [google doc](https://docs.google.com/spreadsheets/d/18iAJnUXEt7IZqJNB9cQhVR9s2IrUHRG7TXeKhDH7qM0/edit?usp=sharing) with the mappings.